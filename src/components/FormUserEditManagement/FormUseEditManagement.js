...
import { ACCESSTOKEN, http } from '../../apis';
import { updateUserManageURL } from '../../apis/apiURL';
...
function FormUseEditManagement({
    ...
    async function submitInfo() {
        if (
            ...
            try {
                await http.put(updateUserManageURL, newUserInfoUpdate);
...
export default FormUseEditManagement;
